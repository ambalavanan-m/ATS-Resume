  ...
  return (
    <div className="mb-4">
      <div className="flex justify-between items-center mb-1">
        <span className="text-sm font-mono uppercase tracking-widest text-text-secondary">{label}</span>
      ...
      <div className="w-full h-2 bg-border/50 rounded-full overflow-hidden">
        <motion.div
          ...
          className="h-full bg-accent shadow-[0_0_10px_rgba(0,212,255,0.2)]"
        />
      </div>
    </div>
  );
