        ...
        {mode === 'upload' ? (
          <div className="space-y-4">
            {!fileName ? (
              ...
              >
                ...
                <p className="text-xs text-[#8b949e] mt-1">PDF only (Max 10MB)</p>
                <input
                  type="file"
                  ref={fileInputRef}
            ...
            <div className="text-xs text-amber-400/80 flex gap-2 items-center italic">
                <AlertCircle size={12} />
                <span>Text and structure extracted locally. No data is stored.</span>
            </div>
          </div>
        ) : (
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full h-48 bg-[#0d1117] border border-[#30363d] rounded-lg p-4 text-sm focus:outline-none focus:border-accent transition-colors resize-none"
            />
          </div>
        )}
